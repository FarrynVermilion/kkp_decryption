        ...
        if not_with_value==true{
            if result.len() == 0 {
                result.extend(vec![
                    ...
                    r#"
                    [[[[52, 153, 48, 249], [77, 53, 47, 253], [193, 151, 98, 191], [141, 138, 156, 201]], [[150, 34, 159, 245], [44, 205, 206, 116], [156, 46, 36, 38], [192, 227, 103, 227]], [[203, 196, 49, 98], [235, 173, 41, 21], [13, 166, 213, 210], [155, 128, 34, 3]]], [[[201, 184, 40, 126], [160, 72, 189, 150], [178, 213, 217, 186], [84, 6, 230, 211]], [[48, 197, 99, 198], [12, 248, 164, 242], [221, 251, 198, 18], [160, 58, 88, 73]], [[7, 175, 73, 129], [134, 25, 36, 124], [29, 174, 183, 242], [75, 143, 208, 32]], [[171, 231, 27, 18], [70, 102, 235, 140], [20, 11, 145, 110], [43, 147, 116, 252]], [[68, 225, 0, 170], [190, 16, 131, 17], [88, 50, 81, 182], [56, 42, 61, 1]], [[104, 15, 13, 36], [72, 244, 77, 171], [67, 45, 81, 164], [64, 75, 117, 117]]]]
                    "#.to_string()
                ]);
            }
        }
        ...
        for x in 0..4 {
            for y in 0..4 {
                for z in 0..4 {
                    ...
                    // let gf = gf256(inverse_matrix_multiplication[x][z],matrix[z][y] );
